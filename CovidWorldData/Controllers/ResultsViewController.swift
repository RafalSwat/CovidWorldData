...
class ResultsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupLabels()
        setupBaseInfoVStackAppearance()
        setupCurrentDataVStackAppearance()
    }
    
    func setupBaseInfoVStackAppearance() {
        baseInfoVStack.setCustomSpacing(-10, after: countryLabel)
        baseInfoVStack.setCustomSpacing(40, after: lastUpdateLabel)
    }
    
    func setupCurrentDataVStackAppearance() {
        currentDataVStack.setCustomSpacing(50, after: seriousOrCriticalHStack)
    }
